...
(function (L06_Hexenkessel) {
    function generateContent(_data) {
        ...
        document.getElementById("Wirkung_value")?.addEventListener("input", L06_Hexenkessel.slider);
        document.getElementById("Zutaten_value")?.addEventListener("input", L06_Hexenkessel.slider);
    }
