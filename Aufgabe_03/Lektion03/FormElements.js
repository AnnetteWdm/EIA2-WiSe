...
(function (L03_FormElements) {
    ...
    function handleChange(_event) {
        let target = _event.target; //target des events wird deklariert
        console.log();
        ...
        if (target.name == "Slider") { //wenn der name des targets Slider ist, dann
            let progress = document.getElementsByTagName("progress")[0]; //output element wird selektiert
